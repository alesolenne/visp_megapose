...
if __name__ == '__main__':
  ...
  object_offsets = {
    'box1_1': (0.063, 0.063, 0.1), 'box1_6': (0.063, 0.063, 0.1), 'box1_3': (0.063, 0.063, 0.1), 'box1_2': (0.063, 0.02, 0.1),
    'box2': (0.024, 0.024, 0.1), 
    'box3': (0.049, 0.049, 0.1), 
    'box4': (0.04, 0.04, 0.1),
    'box5': (0.06, 0.06, 0.1)
  }

  box_counts = {
    'box1_1': (1, 1), 'box1_6': (3, 2), 'box1_3': (3, 8), 'box1_2': (5, 5),
  }
