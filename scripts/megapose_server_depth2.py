...
sys.path.append('/home/vispci/anaconda3/envs/megapose/lib/python3.8/site-packages')
megapose_server_install_dir = os.path.dirname(megapose_server.__file__)
variables_file = '/home/vispci/catkin_ws/src/visp_megapose/scripts/megapose_variables_final.json'
